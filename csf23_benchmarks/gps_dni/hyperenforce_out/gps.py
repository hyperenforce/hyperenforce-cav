...
# ucon_num_la = 30
# ucon_random_flag = true
plant.add_vertex(label=pt(is_cont="0", PC="5", con_num_longitude="0", con_num_latitude="0")) # index:21
plant.add_cont_edges([(0, 21)], weight=[1])
# repeating state at PC=26, goes back to index:2
plant.add_uncont_edges([(21, 2)], weight=[1])
# repeating state at PC=26, goes back to index:3
# repeating uncontrollable edge: (2,3), ignore 
# repeating state at PC=26, goes back to index:4
# repeating uncontrollable edge: (3,4), ignore 
...
# ucon_num_la = 2
# ucon_random_flag = true
plant.add_vertex(label=pt(is_cont="0", PC="5", con_num_longitude="0", con_num_latitude="0")) # index:22
plant.add_cont_edges([(0, 22)], weight=[1])
# repeating state at PC=18, goes back to index:2
plant.add_uncont_edges([(22, 2)], weight=[1])
# repeating state at PC=19, goes back to index:3
# repeating uncontrollable edge: (2,3), ignore 
# repeating state at PC=22, goes back to index:4
# repeating uncontrollable edge: (3,4), ignore 
...
# ucon_num_la = 30
# ucon_random_flag = false
plant.add_vertex(label=pt(is_cont="0", PC="5", con_num_longitude="0", con_num_latitude="0")) # index:23
plant.add_cont_edges([(0, 23)], weight=[1])
# repeating state at PC=22, goes back to index:2
plant.add_uncont_edges([(23, 2)], weight=[1])
# repeating state at PC=22, goes back to index:3
# repeating uncontrollable edge: (2,3), ignore 
# repeating state at PC=22, goes back to index:4
# repeating uncontrollable edge: (3,4), ignore 
...
# ucon_num_la = 30
# ucon_random_flag = false
plant.add_vertex(label=pt(is_cont="0", PC="5", con_num_longitude="0", con_num_latitude="0")) # index:24
plant.add_cont_edges([(0, 24)], weight=[1])
# repeating state at PC=22, goes back to index:2
plant.add_uncont_edges([(24, 2)], weight=[1])
# repeating state at PC=22, goes back to index:3
# repeating uncontrollable edge: (2,3), ignore 
# repeating state at PC=22, goes back to index:4
# repeating uncontrollable edge: (3,4), ignore 
...
# ucon_num_la = 30
# ucon_random_flag = true
plant.add_vertex(label=pt(is_cont="0", PC="5", con_num_longitude="0", con_num_latitude="0")) # index:25
plant.add_cont_edges([(0, 25)], weight=[1])
# repeating state at PC=18, goes back to index:2
plant.add_uncont_edges([(25, 2)], weight=[1])
# repeating state at PC=19, goes back to index:3
# repeating uncontrollable edge: (2,3), ignore 
# repeating state at PC=22, goes back to index:4
# repeating uncontrollable edge: (3,4), ignore 
...
# ucon_num_la = 30
# ucon_random_flag = true
plant.add_vertex(label=pt(is_cont="0", PC="5", con_num_longitude="0", con_num_latitude="0")) # index:26
plant.add_cont_edges([(0, 26)], weight=[1])
# repeating state at PC=18, goes back to index:2
plant.add_uncont_edges([(26, 2)], weight=[1])
# repeating state at PC=19, goes back to index:3
# repeating uncontrollable edge: (2,3), ignore 
# repeating state at PC=22, goes back to index:4
# repeating uncontrollable edge: (3,4), ignore 
