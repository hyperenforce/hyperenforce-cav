...
pt = DataType({'is_cont': ['0', '1', 'null', ''], 'PC': ['4', '13', '16', '20', 'null', ''], 'con_y': ['true', 'false', 'null', '']})
...
plant.add_vertex(label=pt(is_cont="1", PC="20", con_y="true")) # index:4
...
plant.add_vertex(label=pt(is_cont="1", PC="20", con_y="false")) # index:8
...
# repeating state at PC=20, goes back to index:7
plant.add_uncont_edges([(6, 7)], weight=[1])
# repeating state at PC=20, goes back to index:8
