...
jalangiLabel1:
    while (true) {
        try {
            ...
            for (J$.X1(1113, i = J$.W(233, 'i', J$.T(225, 1, 22, false), i, 2)); J$.X1(1105, J$.C(24, J$.B(10, '<=', J$.R(241, 'i', i, 1), J$.T(249, 10000, 22, false), 0))); J$.X1(1121, J$.B(34, '-', i = J$.W(273, 'i', J$.B(26, '+', J$.U(18, '+', J$.R(265, 'i', i, 1)), J$.T(257, 1, 22, false), 0), i, 2), J$.T(281, 1, 22, false), 0))) {
                ...
                if (J$.X1(1089, J$.C(8, J$.R(409, 'ucon_z', ucon_z, 1)))) {
                ...
                if (J$.X1(1097, J$.C(16, J$.R(465, 'ucon_x', ucon_x, 1)))) {
            ...
            J$.X1(809, J$.M(801, J$.R(785, 'console', console, 2), 'log', 0)(`Total execution time w/ monitoring:  X1 = ${ J$.R(793, 'total_exectime', total_exectime, 1) }`));
            J$.X1(857, J$.M(849, J$.R(817, 'console', console, 2), 'log', 0)(`Total execution time w/o monitoring: X2 = ${ J$.B(122, '+', J$.B(114, '-', J$.R(825, 'total_exectime', total_exectime, 1), J$.R(833, 'total_monitoring', total_monitoring, 1), 0), J$.R(841, 'total_no_monitoring', total_no_monitoring, 1), 0) }`));
            J$.X1(889, J$.M(881, J$.R(865, 'console', console, 2), 'log', 0)(`Total monitoring time:               X3 = ${ J$.R(873, 'total_monitoring', total_monitoring, 1) }`));
            J$.X1(945, J$.M(937, J$.R(897, 'console', console, 2), 'log', 0)(`X3/X1 = ${ J$.M(929, J$.B(130, '/', J$.R(905, 'total_monitoring', total_monitoring, 1), J$.R(913, 'total_exectime', total_exectime, 1), 0), 'toFixed', 0)(J$.T(921, 2, 22, false)) } %`));
            J$.X1(969, J$.M(961, J$.R(953, 'console', console, 2), 'log', 0)(`Normalized overhead should be something like: ((X - X_min) / (X_max - X_min)) * 100`));
        } catch (J$e) {
            J$.Ex(1129, J$e);
        } finally {
            if (J$.Sr(1137)) {
