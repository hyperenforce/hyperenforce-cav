...
(function (sandbox) {
    function MyAnalysis() {
        ...
        this.invokeFun = function	(iid,	f,	base,	args,	result,	isConstructor,	isMethod,	functionIid) {
          if (typeof f === "function"){
            if (f == supp_0){
              prev_ucon_str_toml = (args[1])
              // console.log('check supp_0, incokeFun');
              // console.log(args);

              to_suppress_0 = prev_ucon_str_toml===('__proto__')
              ...
              if(to_suppress_0){
                ...
                return {f: f, base: base, args: args, result: prev_ucon_str_toml}
              }
              else{
                // original operation
                // console.log('=== no suppress ===')
                return {f: f, base: base, args: args, result: 'yes'};
              }
            }
            // else if (f == checkvalues){
