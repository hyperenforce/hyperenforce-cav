...
/* SYMBOLIC VARS */
var con_str_polluted = S$.symbol('con_str_polluted', 'null')
var ucon_str_toml = S$.symbol('ucon_toml_str', "[__proto__]\npolluted = \"yes\"\n")
...
// The next line should be suppressed if parsing the toml table will pollute the prototypes, i.e., toml_str contains a row label '__proto__'
// compile(parse(toml_str));
...
// After parsing toml table, the prototype has been polluted, i.e.,
// {}.polluted == "yes"
console.log({}.polluted);
